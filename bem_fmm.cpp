...
int main( int argc, char **argv )
{
  ...
  {
    // infinite::eval_fmm_integral(P,E,C,N,L,Q,sigma,mu,num_expansion,min_pnt_num,4,RGB);
  ...
  std::string png_file=result_folder+model_name+"_bem_"+
                      std::to_string(resol_width)+"_"+std::to_string(resol_height)+"_nonuniform_fmm.png";
