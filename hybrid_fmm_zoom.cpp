...
// omp_set_num_threads(1);
  ...
  int ng = 4;//4; //number of quadrature points
  int ns = 20;//20; //number of line segments for solving stage
  ...
  Eigen::VectorXd cL = infinite::bezier_length(CPs);
  {
    ...
    std::string png_file = save_folder+"/"+model_name+"_hybrid_fmm_adap.png";
